...
//| Stop loss calculated through risk amount and fixed lot size.     |
   ...
   for(int SymbolLoop=0; SymbolLoop < NumberOfTradeableSymbols; SymbolLoop++)
   {
      ...
      if(TimeLastTickProcessed[SymbolLoop] != iTime(CurrentSymbol,Period(),0))
      {
         ...
         )
         {
            ...
            StopLossPrice      = GetStopLoss(CurrentSymbol, EntryPrice, OrderType, RiskLots, RiskAmount);
            TakeProfitPrice    = 0.0;
