...
//| Stop loss and take profit uses ATR multiple. Position size is    |
//| calculated using a percentage of account. User can select either |
//| fixed or compounding position sizing.                            |
//+------------------------------------------------------------------+
